    ...
    <Router>
      <div className="min-h-screen bg-white">
        ...
        <Routes>
          ...
          <Route path="/solutions/customer-compliance" element={<CustomerCompliance />} />
          <Route path="/solutions/vendor-management" element={<VendorManagement />} />
          <Route path="/solutions/merchant-monitoring" element={<MerchantMonitoring />} />
          <Route path="/solutions/risk-assessment" element={<RiskAssessment />} />
          ...
          <Route path="/industries/payment-processors" element={<PaymentProcessors />} />
          <Route path="/industries/digital-lending" element={<DigitalLending />} />
