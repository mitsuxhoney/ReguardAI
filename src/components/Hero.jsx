      ...
      <div className="max-w-6xl mx-auto px-6 lg:px-8 relative">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <motion.div
            ...
            className="flex justify-center items-center gap-2 px-4 rounded-full text-sm font-medium"
          >
            {/* <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          ></motion.div> */}
            ...
            <div
              className="relative flex w-full max-w-[500px] items-center justify-center overflow-hidden px-10 py-10"
              ref={containerRef}
            >
          ...
          >
            AI-powered post-onboarding compliance that has prevented{' '}
            <strong className="text-reguard-navy">
              ₹2000+ Crores in fraud
            </strong>{' '}
            for Indian Banks, Fintech, and NBFCs
          </motion.p>
        ...
        >
          {[
            ...
            >
              <div className="text-4xl font-bold text-reguard-navy mb-2">
                {stat.value}
              </div>
