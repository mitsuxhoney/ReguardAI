  ...
  return (
    <motion.header 
      ...
      className={cn(
        ...
        isScrolled 
          ? "bg-white/95 backdrop-blur-xl border-b border-reguard-200 shadow-lg" 
    ...
    >
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative">
        <div className={cn(
          ...
          <nav className="hidden lg:flex items-center space-x-8">
            <motion.div whileHover={{ y: -1 }} transition={{ type: "spring", stiffness: 400, damping: 25 }}>
              <Link 
                to="/" 
                className="relative text-reguard-navy hover:text-reguard-red transition-all duration-300 font-semibold text-base tracking-tight group px-3 py-2 rounded-lg hover:bg-red-50"
              >
                Home
                <span className="absolute -bottom-0.5 left-3 w-0 h-0.5 bg-reguard-red group-hover:w-[calc(100%-24px)] transition-all duration-300"></span>
              </Link>
            </motion.div>
          ...
          <motion.button 
            className="lg:hidden text-reguard-navy hover:text-reguard-accent-600 transition-colors duration-300"
        ...
        {isMenuOpen && (
          <motion.div 
            className="lg:hidden absolute top-full left-0 right-0 bg-white/95 backdrop-blur-xl border-b border-reguard-200 shadow-xl"
          ...
          >
            <div className="px-6 py-6 space-y-4">
              <Link to="/" className="block text-reguard-navy hover:text-reguard-red transition-colors py-3 border-b border-gray-100 font-medium">Home</Link>
              <Link to="/about" className="block text-reguard-navy hover:text-reguard-red transition-colors py-3 border-b border-gray-100 font-medium">About</Link>
              <Link to="/solutions" className="block text-reguard-navy hover:text-reguard-red transition-colors py-3 border-b border-gray-100 font-medium">Solutions</Link>
              <Link to="/industries" className="block text-reguard-navy hover:text-reguard-red transition-colors py-3 border-b border-gray-100 font-medium">Industries</Link>
              <Link to="/contact" className="block text-reguard-navy hover:text-reguard-red transition-colors py-3 border-b border-gray-100 font-medium">Contact</Link>
              
              <div className="pt-4 space-y-3">
                <Button variant="ghost" className="w-full justify-start text-reguard-navy hover:bg-red-50 hover:text-reguard-red font-medium">Sign In</Button>
                <Button 
